...
/**
 * Activity corresponding to the the compete (multi-player) mode.
 */
public class CompeteModeActivity extends FragmentsActivity
    ...
    /**
     * Loads the {@link ResultFragment} with the appropriate result, and registers the win to the
     * {@link BuzzerCountStatisticsManager}/
     */
    @Override
